<?php
class ControllerSimpleBlogGeneralSetting extends Controller {
    ...
    public function getData() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->response->redirect($this->url->link('simple_blog/general_setting', 'token=' . $this->session->data['token'], 'SSL'));
        }
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href'      => $this->url->link('simple_blog/general_setting', 'token=' . $this->session->data['token'], 'SSL'),
            'separator' => ' :: '
        );

        $data['action'] = $this->url->link('simple_blog/general_setting', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $this->response->setOutput($this->load->view('simple_blog/general_setting.tpl', $data));
    }

    protected function validate() {
        if (!$this->user->hasPermission('modify', 'simple_blog/general_setting')) {
