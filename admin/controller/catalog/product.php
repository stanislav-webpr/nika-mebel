...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
        ...
        if(isset($this->request->get['product_id']) && ($this->config->get('proposition_status') && $this->config->get('proposition_status') == 1)) {
            ...
            $data['tab_proposition'] = $this->language->get('tab_proposition');
        }
        //************
        ...
        if(isset($this->request->get['product_id']) && ($this->config->get('complects_status') && $this->config->get('complects_status') == 1)) {
            ...
            $data['entry_complect_product_width'] = $this->language->get('entry_complect_product_width');
            $data['entry_complect_product_height'] = $this->language->get('entry_complect_product_height');
            $data['entry_complect_product_price'] = $this->language->get('entry_complect_product_price');
            $data['entry_complect_product_sort'] = $this->language->get('entry_complect_product_sort');
