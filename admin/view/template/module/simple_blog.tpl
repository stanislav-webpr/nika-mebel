                ...
                <div class="panel-body">
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-simple-blog" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                <input type="text" name="article_limit" value="<?php echo $article_limit; ?>" class="form-control"/>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                <select name="category_id" class="form-control">
                                    ...
                                    <?php foreach ($categories as $category) { ?>
                                        <option value="<?php echo $category['simple_blog_category_id']; ?>" <?php if ($category['simple_blog_category_id'] == $category_id) {
                                            echo "selected='selected'";
