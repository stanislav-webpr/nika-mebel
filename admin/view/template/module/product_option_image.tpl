                ...
                <div class="panel-body">
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category-wall" class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="product_color_change_status" id="input-status" class="form-control">
                                    <?php if ($product_color_change_status) { ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="product_color_change_status" id="input-cart" class="form-control">
                                    <?php if ($product_color_change_cart) { ?>
                                        <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                                        <option value="0"><?php echo $text_disabled; ?></option>
                                    <?php } else { ?>
                                        <option value="1"><?php echo $text_enabled; ?></option>
