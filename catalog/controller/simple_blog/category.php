...
//						$image = HTTP_SERVER . 'image/' . $result['image'];
					...
					$data['articles'][] = array(
						...
						'href'				=> $this->url->link('simple_blog/article/view', 'simple_blog_article_id=' . $result['simple_blog_article_id'] . "&simple_blog_category_id=" . $this->request->get['simple_blog_category_id'], 'SSL'),
