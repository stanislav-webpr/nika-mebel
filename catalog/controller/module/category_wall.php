...
class ControllerModuleCategoryWall extends Controller {
	public function index() {
		...
		foreach ($categories as $category) {
			...
			if($category['image']) {
				$image = $this->model_tool_image->resize($category['image'], $this->config->get('config_image_category_wall_width'), $this->config->get('config_image_category_wall_height'));
			} else {
				$image = $this->model_tool_image->resize('placeholder.png', $this->config->get('config_image_category_wall_width'), $this->config->get('config_image_category_wall_height'));
			}
