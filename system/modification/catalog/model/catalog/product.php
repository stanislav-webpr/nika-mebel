...
class ModelCatalogProduct extends Model {
    ...
    public function getComplect($product_id) {
        $result = array();
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "complect c LEFT JOIN " . DB_PREFIX . "complect_product cp ON (cp.complect_id = c.complect_id) WHERE c.product_id = " . (int)$product_id . " ORDER BY cp.sort");
        if ($query->num_rows) {
    ...
    public function getComplectProduct($product_id, $complect_product_id) {
        $query = $this->db->query("SELECT cp.* FROM " . DB_PREFIX . "complect c LEFT JOIN " . DB_PREFIX . "complect_product cp ON (cp.complect_id = c.complect_id) WHERE c.product_id = " . (int)$product_id . " AND cp.product_id = " . (int) $complect_product_id);
        return $query->row;
    }
}
